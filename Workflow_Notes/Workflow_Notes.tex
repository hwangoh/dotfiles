...
%==============================================================================
\section{Vim in Windows}
%==============================================================================
In this section, we utilize WSL2 is second version of the Windows Subsystem for Linux.

%------------------------------------------------------------------------------
\subsection{Installing WSL2}
%------------------------------------------------------------------------------
To install WSL2, use
the following steps \cite{bombal2020wsl2}:
\begin{itemize}
    \item In the search bar, find and open "Turn Windows features on or off"
    \item Enable "Windows Subsystem for Linux" and "Virtual Machine Platform"
    \item Go to the "Microsoft Store" and search for Ubuntu. Get, install and launch it.
\end{itemize}
To remap caps lock to escape, I use sharpkeys \cite{randyrants2020sharpkeys}. To
install, use the following steps:
\begin{itemize}
    \item Scroll down to the "Install" section and click the "Releases" link
    \item Download "sharpkeys392.msi"
\end{itemize}
From here, it is pretty straight forward to use it to remap keys.
