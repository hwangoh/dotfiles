...
nmap ,sC mqA<CR>clear<Esc>V,suu`qdmq 
nmap ,sD mqA<CR>%reset<Esc>V,suiy<Esc>v,suu`qdmq
...
" Clear, Reset, Run Variable, Run Marked Section and Run Code
nmap ,C mq:SlimuxShellRun clear<CR>`qdmq
nmap ,D mq:SlimuxShellRun %reset<CR>:SlimuxShellRun y<CR>`qdmq
nmap ,V mqviw,-`qdmq
nmap ,M mq'xV'z,-`qdmq
nmap ,R mqA<CR>run ;F<Esc>V,-uuu`qdmq
\end{lstlisting}
