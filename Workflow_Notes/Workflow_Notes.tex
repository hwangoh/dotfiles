...
\end{lstlisting}
Be sure to use recursive mappings which will allow us to reuse the `,s' mappings
from before.
...
\end{lstlisting}
where SlimuxREPLSendBuffer sends all the text in the bugger and SlimexShellRun
awaits a command to send to shell.
