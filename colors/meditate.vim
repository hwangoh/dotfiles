...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi MatchParen ctermbg=234 ctermfg=109 cterm=NONE guibg=#1c1c1c guifg=#87afaf gui=NONE
    ...
    hi Search ctermbg=109 ctermfg=235 cterm=NONE guibg=#87afaf guifg=#262626 gui=NONE
