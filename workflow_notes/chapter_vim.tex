...
%---------------------------------------------------------------
NOTE: As of 22/04/2025, this seems to clash with YouCompleteMe on WSL2.
I haven't checked if this is the same for Linux.\\

In my dotfiles repository \cite{hwangoh2020dotfiles}, you can run
\textbf{install\_vimtex\_packages.sh} to install the necessary packages
for forward and backwards navigation.\\
