...
%==============================================================================
NOTE: As of 22/04/2025, this seems to be no longer required.
Forward and backwards search works out of the box with WSL and vim-gtk3
as mentioned in Section \ref{SecFwdBckwdSynctex}.\\
...
NOTE: As of 22/04/2025, this seems to be no longer required.
Forward and backwards search works out of the box with WSL and vim-gtk3
as mentioned in Section \ref{SecFwdBckwdSynctex}. On 14/01/2026 I finally
upgraded to Windows 11 (against my will) but it seems like you need a Vimtex
version higher than my previous freeze at v2.10.\\
