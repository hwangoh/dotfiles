...
let s:cpo_save=&cpo
set cpo&vim
inoremap <F5>  :VimtexView
inoremap <F6>  :w! | :VimtexCompileSS
nnoremap  4
nnoremap <silent>  :put =repeat([''],v:count)|'[-1
...
nnoremap j gj
nnoremap k gk
nnoremap <F5> :VimtexView
nnoremap <F6> :w! | :VimtexCompileSS
vnoremap <silent> <Plug>NetrwBrowseXVis :call netrw#BrowseXVis()
nnoremap <silent> <Plug>NetrwBrowseX :call netrw#BrowseX(expand((exists("g:netrw_gx")? g:netrw_gx : '<cfile>')),netrw#CheckIfRemote())
map <F2> :call SyntasticToggle()
...
nnoremap <Down> gj
inoremap    /<++>"_c4l
inoremap ;lrn \left\lVert\right\rVert<++>15hi 
inoremap ;lrp \left(\right)<++>12hf(a
inoremap ;mrm \mathrm{}<++>6hf}i
inoremap ;frc \frac{}{<++>}<++>12hf}i
inoremap ;su ^{}<++>6hf}i
inoremap ;sd _{}<++>6hf}i
inoremap ;T ^\mathrm{T}
inoremap ;fig \begin{figure}[H]\centering\includegraphics[scale=\figscale]{}\caption{<++>}\label{<++>}\end{figure}<++>4kf}i
inoremap ;lst \begin{lstlisting}\end{lstlisting}<++>2kA
inoremap ;sub \begin{subequations}\begin{align}\end{align}\end{subequations}<++>3kA	
inoremap ;aln \begin{align}\end{align}<++>2kA
inoremap ;enu \begin{enumerate}\end{enumerate}<++>2kA\item 
inoremap ;itm \begin{itemize}\end{itemize}<++>2kA\item 
inoremap ;prf (\ref{})<++>7hf}i
inoremap ;rf \ref{}<++>6hf}i
inoremap ;lb \label{}<++>6hf}i
inoremap ;ct \cite{}<++>6hf}i
inoremap ;it \textit{}<++>6hf}i
inoremap ;bf \textbf{}<++>6hf}i
inoremap ;mm $$<++>6ha
inoremap ;ssec %---------------------------------------------------------------\subsection{}%---------------------------------------------------------------   <++>2k0f}i
inoremap ;sec %===============================================================\section{}%===============================================================<++>2k0f}i
let &cpo=s:cpo_save
...
set errorfile=~/pCloudDrive/Work/PostDoc/Documents/My\ Notes/KAUST_Seattle_Notes/KAUST_seattle_notes.log
set expandtab
...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-airline,~/.vim/bundle/vimtex,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/bundle/vimtex/after,~/.vim/after
set shiftround
set shiftwidth=4
set showtabline=2
set smartcase
...
silent only
cd ~/pCloudDrive/Work/PostDoc/Documents/My\ Notes/KAUST_Seattle_Notes
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +48 KAUST_seattle_notes.tex
argglobal
silent! argdel *
$argadd KAUST_seattle_notes.tex
edit KAUST_seattle_notes.tex
...
xnoremap <buffer> <silent> <SNR>125_(vimtex-]]) :call vimtex#motion#section(0,0,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-][) :call vimtex#motion#section(1,0,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-[]) :call vimtex#motion#section(1,1,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-[[) :call vimtex#motion#section(0,1,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-]m) :call vimtex#motion#environment(1,0,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-]M) :call vimtex#motion#environment(0,0,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-[m) :call vimtex#motion#environment(1,1,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-[M) :call vimtex#motion#environment(0,1,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-]/) :call vimtex#motion#comment(1,0,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-]*) :call vimtex#motion#comment(0,0,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-[/) :call vimtex#motion#comment(1,1,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-[*) :call vimtex#motion#comment(0,1,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-[*) :call vimtex#motion#comment(0,1,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-[/) :call vimtex#motion#comment(1,1,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-]*) :call vimtex#motion#comment(0,0,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-]/) :call vimtex#motion#comment(1,0,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-[M) :call vimtex#motion#environment(0,1,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-[m) :call vimtex#motion#environment(1,1,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-]M) :call vimtex#motion#environment(0,0,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-]m) :call vimtex#motion#environment(1,0,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-[[) :call vimtex#motion#section(0,1,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-[]) :call vimtex#motion#section(1,1,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-][) :call vimtex#motion#section(1,0,1)
xnoremap <buffer> <silent> <SNR>99_(vimtex-]]) :call vimtex#motion#section(0,0,1)
...
xnoremap <buffer> <silent> <SNR>140_(vimtex-[*) :call vimtex#motion#comment(0,1,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-[/) :call vimtex#motion#comment(1,1,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-]*) :call vimtex#motion#comment(0,0,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-]/) :call vimtex#motion#comment(1,0,1)
...
xnoremap <buffer> <silent> <SNR>140_(vimtex-[M) :call vimtex#motion#environment(0,1,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-[m) :call vimtex#motion#environment(1,1,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-]M) :call vimtex#motion#environment(0,0,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-]m) :call vimtex#motion#environment(1,0,1)
...
xnoremap <buffer> <silent> <SNR>140_(vimtex-[[) :call vimtex#motion#section(0,1,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-[]) :call vimtex#motion#section(1,1,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-][) :call vimtex#motion#section(1,0,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-]]) :call vimtex#motion#section(0,0,1)
...
51
normal! 0150|
lcd ~/pCloudDrive/Work/PostDoc/Documents/My\ Notes/KAUST_Seattle_Notes
tabnext 1
if exists('s:wipebuf')
